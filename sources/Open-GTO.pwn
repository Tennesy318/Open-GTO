...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    { 
        ...
        else ShowPlayerDialog(playerid, 221, DIALOG_STYLE_INPUT, "¬ыбор скина", "¬ведите ID", "OK", "назад"); 
    }  
	switch (dialogid)
	{
...
{
    if(clickedid == idz) // провер€ем, если игрок нажал именно на textdraw mxINI, то...
    {
		ShowPlayerDialog(playerid,221,DIALOG_STYLE_INPUT, "¬ыбор скины", "¬ведите ID", "OK", "назад"); 
